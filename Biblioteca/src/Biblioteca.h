...
typedef enum{
	...
	RESP_ERROR_TABLA_NO_EXISTE,
	RESP_ERROR_DESCONOZCO_CRITERIO_TABLA,
	RESP_ERROR_SIN_MEMORIAS_CRITERIO,
	RESP_ERROR_SIN_MEMORIAS_ASOCIADAS,
	RESP_ERROR_GENERAL,
	...
	RESP_ERROR_TABLA_YA_EXISTE,
	RESP_ERROR_KEY_NO_EXISTE,
